...
// Show the menu up top. Something like [home] [help] [profile] [logout]... <span class="', isset($button['is_last']) ? 'last ' : '', 'firstlevel">', $button['title'], '</span>
function template_menu()
{
	...
	foreach ($context['menu_buttons'] as $act => $button)
	{
		echo '
				<li id="button_', $act, '">
					<a class="', $button['active_button'] ? 'active ' : '', '', isset($button['is_last']) ? ' last ' : '', '" href="', $button['href'], '"', isset($button['target']) ? ' target="' . $button['target'] . '"' : '', '><span></span>
					<span class="firstlevel">
							<img style="vertical-align: middle;" src="'. $settings['images_url']. '/menu/'. $act. '.png" alt="'. $button['title']. '" title="'. $button['title']. '"/>
					</span>
...
function copyright()
{
	$copy = 'Theme by <a href="https://smftricks.com">SMF Tricks</a>';
...
function UserArea()
{
	...
	if($context['user']['is_logged']) 
	{
		...
		<div class="floatright">
			<div id="draggable" class="ui-draggable" style="left: 1540px; top: 186px;">
				<div class="userareap">
					<div style="width: 100%;">
					...
					<div class="panel_block">
						<a href="', $scripturl, '?action=profile;area=forumprofile" title="', $txt['forumprofile'], '">
							<img src="', $settings['images_url'], '/userarea/1.png" alt="" />							
						</a>
					</div>
					<div class="panel_block floatright">
						<a href="', $scripturl, '?action=unread" title="', $txt['unread_topics_visit'], '">
							<img src="', $settings['images_url'], '/userarea/3.png" alt="" />
						</a>
					</div>
					<div class="panel_block floatleft">
						<a href="', $scripturl, '?action=unreadreplies" title="', $txt['unread_replies'], '">
							<img src="', $settings['images_url'], '/userarea/2.png" alt="" />
						</a>
					</div>
					<br class="clear" />
					<div class="panel_block">
						<a href="', $scripturl, '?action=profile;area=theme" title="', $txt['account'], '">
